...
function sellPatientCard($data)
{
  ...
  $response .= '"' . $data['id'] . '","' . $data['nombre'] . '","' . $data['apellido_paterno'] . ' ' . $data['apellido_materno'] . '", "' . $data['telefono_secundario'] . '"';
...
function sellCard($data)
{
  ...
  $response .= "'" . $data['id_venta'] . "','" . ucwords($data['nombre']) . "','" . ucwords($data['apellidos']) . "','" . $data['fecha'] . "','" . $tipoPago . "','" . $modalidadPago . "', '" . $descuento . "', '" . $anticipo . "', '" . $mensualidades . "','" . $precioMes . "','" . $interes . "'," . floatval($data['total']) . "";
