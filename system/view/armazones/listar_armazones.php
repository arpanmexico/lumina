...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Todos los armazones / <a class="text-info" href="?crearArmazon"><i class="fas fa-plus-circle"></i> Crear Nuevo Producto</a> </h6>
    </div>
    <div class="card-body">
        <div class="row">
            <?php
